	...
	<view>
		...
		<view class="my-top" @click="goUpdate">
			...
			<view class="my-top-mes">
				...
				<view class="my-top-mes-type">{{userInfo.branch}} | {{userInfo.post}}</view>
			</view>
			<!-- <image class="my-top-zhe" src="/static/images/dangbiao.png"></image> -->
		</view>
		...
		<!-- <view class="my-li" @click="goRanking">
			<image class="my-li-img" src="/static/images/my1.png"></image>
			<text class="my-li-text">积分排行榜</text>
			<image class="my-li-zhe" src="/static/images/zhe.png"></image>
		</view> -->
		<!-- <view class="my-li" @click="goAnsHistory">
			<image class="my-li-img" src="/static/images/my2.png"></image>
			<text class="my-li-text">答题记录</text>
			<image class="my-li-zhe" src="/static/images/zhe.png"></image>
		</view> -->
		...
		<view class="my-li" @click="goHome">
			<image class="my-li-img" src="/static/images/index7dongtai.png"></image>
			<text class="my-li-text">返回首页</text>
			<image class="my-li-zhe" src="/static/images/zhe.png"></image>
		</view>
		<!-- <view class="my-li" @click="goHome">
			<image class="my-li-img" src="/static/images/index6.png"></image>
			<text class="my-li-text">返回首页</text>
			<image class="my-li-zhe" src="/static/images/zhe.png"></image>
		</view> -->
		...
		<view class="my-weiyue">山东万岳科技版权所有  </view>
		<view class="my-weiyue">联系电话：157 1144 9029</view>
	</view>
</template>
